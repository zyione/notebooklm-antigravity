...
export default function AuthButton() {
  ...
  return (
    <button
      ...
      className="flex items-center gap-2 bg-white dark:bg-gray-900 border border-gray-300 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-800 text-gray-700 dark:text-gray-300 font-medium py-1.5 px-4 rounded-lg shadow-sm transition-all text-sm"
    >
